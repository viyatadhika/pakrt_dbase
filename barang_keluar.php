...
<div class="header-container">
    <header class="px-4 py-4 flex items-center justify-between bg-white">
        ...
        <button onclick="openExportModal()"
            class="w-10 h-10 flex items-center justify-center text-orange-600 hover:bg-orange-50 rounded-full transition">
    ...
    <div class="px-4 pt-2 pb-4 bg-white">
        <div class="relative group">
            ...
            <input type="text" id="searchTransaksi" placeholder="Cari ref / penerima / barang / kategori..."
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="date" id="exportFrom"
                        class="w-full mt-1 px-4 py-3 rounded-2xl bg-gray-50 border border-gray-200 outline-none focus:border-orange-300">
                </div>
                ...
                <button onclick="downloadExport()"
                    class="w-full py-3 rounded-2xl bg-orange-600 text-white font-extrabold text-sm">
                    Download PDF
                </button>
...
<script>
    ...
    function downloadExport() {
        ...
        let url = "barang_keluar_export.php";
        const params = [];
    ...
    function openSheetLocal(el) {
        ...
        items.forEach(i => {
            ...
            const key = i.kategori_color || "sky";
            const clr = colorMap[key] || {
                bg: "bg-gray-100",
                text: "text-gray-600"
            };
            html += `
