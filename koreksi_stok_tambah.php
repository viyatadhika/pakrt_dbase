...
<style>
    ...
    select {
        appearance: none;
        background-image: url("data:image/svg+xml,%3csvg xmlns='https://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%2394a3b8' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e");
    ...
    <header class="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-[12px] text-gray-500">Tambah / Kurang stok gudang</p>
            </div>
        </div>
        <div class="flex items-center">
            <p id="displayRef" class="text-[10px] sm:text-[11px] font-semibold text-sky-700 bg-sky-50 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-sky-100">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div class="space-y-6 animate-slide-up">
                ...
                <div class="card-custom p-6 bg-white border-sky-50 bg-sky-50/5">
                    ...
                    <div class="space-y-5">
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1.5 ml-1">Tanggal Koreksi</label>
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1.5 ml-1">Jenis Koreksi</label>
                            <div class="input-with-icon">
                                <select id="inpJenis"
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1.5 ml-1">Alasan</label>
                            <div class="input-with-icon">
                                <input type="text" id="inpAlasan" required placeholder="Contoh: Koreksi selisih stok"
                                    class="input-field w-full px-4 py-3 bg-white border border-slate-100 rounded-xl outline-none transition text-sm">
                        ...
                        <div>
                            ...
                            <div class="input-with-icon">
                                <textarea id="inpKet" placeholder="Catatan tambahan..." rows="2"
                ...
                <div class="card-custom p-6 bg-white border-sky-100">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1.5 ml-1">Jumlah Koreksi</label>
                            <div class="input-with-icon">
            ...
            <div class="space-y-6 animate-slide-up" style="animation-delay: 0.1s;">
                <div class="card-custom min-h-[400px] flex flex-col bg-white">
                    ...
                    <div id="cartList" class="flex-1 p-4 sm:p-6 space-y-3 custom-scrollbar overflow-y-auto max-h-[500px]">
...
<script>
    ...
    function addItem() {
        ...
        const opt = sel.options[sel.selectedIndex];
        const stokTersedia = parseInt(opt.getAttribute('data-stok'));
        const jenis = document.getElementById('inpJenis').value;

        if (jenis === 'kurang' && qty > stokTersedia) {
    ...
    function renderCart() {
        ...
        if (state.items.length === 0) {
            ...
            list.innerHTML = state.items.map((item, index) => `
                <div class="bg-white p-4 rounded-xl border border-gray-100 flex flex-col gap-2 animate-slide-up shadow-sm relative overflow-hidden">
                    ...
                    <div class="flex justify-between items-center bg-slate-50 p-2 rounded-lg mt-1">
                        <div class="pl-2">
                            ...
                            <p class="text-sm font-black ${jenis === 'tambah' ? 'text-emerald-700' : 'text-red-700'}">
                                ${jenis === 'tambah' ? '+ ' : '- '}${item.qty}
    ...
    async function simpanTransaksi() {
        ...
        try {
            ...
            alert('Koneksi gagal / server error');
            btn.disabled = false;
            btn.innerHTML = 'Konfirmasi Koreksi';
        }
    }
